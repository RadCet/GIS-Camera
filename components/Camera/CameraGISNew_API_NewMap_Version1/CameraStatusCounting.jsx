...
class CameraStatusCounting extends Component {
    ...
    onCount() {
        const {cameraDataByLayer} = this.props;
        ...
        const _camAI24hEvent = cameraDataByLayer.filter((item) => item.ailevel === 5 || item.ailevel === 4).length;
        ...
        const _camAI = _camAINoEvent + _camAI24hEvent;// + _camAI5pEvent;

        const _camAll = _camBroken + _camUnbroken + _sumCamSocial;// - _camSocial;
    ...
    render() {
        // TODO distinct cam
        const {handleFilter, currentFilter} = this.props;
        const {camAll, camUnbroken, camActive, camUnactive, camBroken, camAI, camAI5pEvent, camAI24hpEvent, camSocial, sumCamSocial} = this.state;
        const boldStyle = {fontWeight: 'bold'};
        return (
            <div style={{fontSize: '15px'}}>
                <div style={{marginBottom: '8px', cursor: 'pointer'}} onClick={()=>handleFilter(StatisData.ALL)}>
                ...
                <div style={{paddingLeft: 23}}>
                    <div style={{marginBottom: '8px', cursor: 'pointer'}} onClick={()=>handleFilter(StatisData.UNBROKEN)}>
                    ...
                    <div style={{paddingLeft: 23}}>
                        <div style={{marginBottom: '8px', cursor: 'pointer'}} onClick={()=>handleFilter(StatisData.ACTIVE)}>
                        ...
                        <div style={{marginBottom: '8px', cursor: 'pointer'}} onClick={() => handleFilter(StatisData.UNACTIVE)}>
                    ...
                    <div style={{marginBottom: '8px', cursor: 'pointer'}} onClick={()=>handleFilter(StatisData.BROKEN)}>
                    ...
                    <div style={{marginBottom: '8px', cursor: 'pointer'}} onClick={()=>handleFilter(StatisData.AI)}>
                    ...
                    <div style={{paddingLeft: 23}}>
                        <div style={{marginBottom: '8px', cursor: 'pointer'}} onClick={()=>handleFilter(StatisData.EVENT24H)}>
                        ...
                        <div style={{marginBottom: '8px', cursor: 'pointer'}} onClick={()=>handleFilter(StatisData.EVENT5P)}>
                    ...
                    {
                        sumCamSocial > 0 ?
                            <div style={{marginBottom: '8px', cursor: 'pointer'}} onClick={()=>handleFilter(StatisData.SOCIAL)}>
