...
class DashboardViewPage extends Component {
  constructor(props) {
    super(props);
    const isDarkTheme = window.localStorage.getItem("isDarkThemeCamera");
    this.dashboard = null;
    // this.isInitilialLoading = true; // CuongNT: Bo hieu ung mo panel khi vao lan dau.
    this.state = {
      dashboardFetchStatus: HttpStatus.UNKNOWN,
      isSidePaneOpen: false, // true, CuongNT: Bo hieu ung mo panel khi vao lan dau.
      isCurrentThemeDark: isDarkTheme ? isDarkTheme === "true" : false,
      embedWidget: false
    };
  ...
  fetchDashboard() {
    new DashboardAPI()
      .getDashboardByID(this.props.match.params.dashboardId)
      .then(response => {
  ...
  render() {
    ...
    if (!this.props.match.params.pageId) {
      return (
        <Redirect to={this.getNavigationToPage(this.dashboard.landingPage)} />
      );
    }
    // CuongNT: Bo hieu ung mo panel khi vao lan dau.
          ...
          style={
            !this.state.embedWidget
              ? {
                  ...
                  right: 0,
                  bottom: 0,
                  // width: 'calc(100% - 25px)', CuongNT: bo pagelist
                  width: "100%",
                  overflowX: "hidden",
                  overflowY: "auto"
                }
  ...
  renderSidePane(theme) {
    ...
    return (
      ...
      >
        ...
        <br />
        {/*CuongNT: Bo phan xuat PDF o cuoi panel*/}
        {/*<Divider />*/}
      ...
      pagesList.push(
        <ListItem
          ...
          onClick={() => {
            ...
            // CuongNT: them de dong panel lai
            this.handleSidePaneToggle();
          }}
